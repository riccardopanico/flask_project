...
from app.utils.solutions.solutions import BaseSolution, SolutionAnnotator, SolutionResults
...
class ObjectCounter(BaseSolution):
    ...
    def process(self, im0):
        ...
        # self.display_output(plot_im)  # Display output with base class function - commented out to prevent GUI windows
