...
class BaseSolution:
    ...
    def __init__(self, is_cli: bool = False, **kwargs):
        ...
        if self.__class__.__name__ != "VisualAISearch":
            ...
            self.env_check = False  # Disabled to prevent any GUI-related checks
    ...
    def display_output(self, plot_im: np.ndarray):
        ...
        This method is responsible for visualizing the output of the object detection and tracking process.
        Currently disabled to prevent GUI windows from appearing in server/headless environments.
        ...
        Notes:
            - This method is currently disabled to prevent unwanted GUI windows.
            - The display functionality has been commented out for headless operation.
        """
        # All display functionality disabled to prevent GUI windows
        pass
